...
CONTAINER_NAME="playnice_please-build-release-static"
...
BINARY="${SCRIPT_DIR}/target/x86_64-unknown-linux-musl/release/playnicepls"
...
RELEASE_DIR="${SCRIPT_DIR}/releases/playnice_please-x86_64-linux-static-${VERSION}"
mkdir -p "$RELEASE_DIR"
